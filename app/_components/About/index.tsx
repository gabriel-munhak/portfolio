const About = () => {
    return (
        <div className="lg:w-[30.4375rem] md:w-[20.375rem]">
            ...
            <p className="lg:mb-[2rem] text-justify mb-[1rem] lg:text-[1rem] md:text-[0.75rem] lg:h-[auto] h-[12.1875rem] lg:overflow-y-auto md:overflow-y-scroll custom-scrollbar">
