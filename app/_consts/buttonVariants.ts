    ...
    "inline-block font-black transition",
    {
        variants: {
            ...
            size: {
                ...
                md: "px-[14px] py-[6px] lg:px-[22px] lg:py-[8px] text-[14px] rounded-[12px]",
                sm: "px-[0.875rem] py-[0.375rem] lg:px-[1rem] lg:py-[0.5rem] text-[0.875rem] lg:text-[1rem] rounded-[0.625rem] lg:rounded-[0.75rem]",
